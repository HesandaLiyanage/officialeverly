<%-- Created by IntelliJ IDEA. User: nethm Date: 8/18/2025 Time: 11:50 AM To change this template use File | Settings |
  File Templates. --%>
  <%@ page contentType="text/html;charset=UTF-8" language="java" %>
    ...
    <head>
      ...
      <!-- Google Fonts -->
      <link
        href="https://fonts.googleapis.com/css2?family=Playwrite+US+Trad&family=Plus+Jakarta+Sans:wght@400;500;600;700&display=swap"
        rel="stylesheet">
      <!-- CSS -->
