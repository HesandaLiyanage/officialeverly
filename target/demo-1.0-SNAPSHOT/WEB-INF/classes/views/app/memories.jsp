            ...
            <c:choose>
                ...
                <c:otherwise>
                    ...
                    <c:forEach var="memory" items="${memories}">
                        ...
                        <div class="memory-card" data-title="${memory.title}" onclick="location.href='/memoryview?id=${memory.memoryId}'" style="cursor: pointer;">
                            ...
                            <div class="memory-content">
                                ...
                                <c:if test="${not empty memory.description}">
                                    <p class="memory-description" style="margin: 8px 0 0 0; color: #888; font-size: 13px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                                        ${memory.description}
                                    </p>
                                </c:if>
                            </div>
        ...
        <div class="sidebar-section">
            ...
            <ul class="favorites-list">
                <li class="favorite-item">
                    ...
                    <span class="favorite-name">Total Memories: <c:out value="${memories.size()}" default="0"/></span>
                </li>
            </ul>
        </div>
