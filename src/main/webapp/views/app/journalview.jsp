            ...
            <%@ page import="com.google.gson.Gson" %>
                    ...
                    <%@ page import="com.google.gson.JsonElement" %>
                        <%@ page import="org.apache.commons.text.StringEscapeUtils" %>
                            <% // Retrieve the Journal object from the request attribute set by the logic handler
                                ...
                                !decorationsElement.isJsonNull() && decorationsElement.isJsonArray()) { // Add a
                                container for decorations and append the decoration elements dynamically via JS content
                ...
                content = " <p>Error loading content: " + e.getMessage() + "</p>";
                                ...
                                <body>
                                                ...
                                                <div class="page-container" id="pageContainer">
                                                    ...
                                                    <div class="journal-page">
                                                        ...
                                                        <button class="favorite-heart" id="favoriteHeart"
                                                            style="display: none;"
                                                            title="Favorite (Not implemented yet)">
                                    ...
                                    <!-- Hidden input for journal content (for JavaScript to read safely) -->
                                    <input type="hidden" id="journalContentData"
                                        value="<%= journal != null ? org.apache.commons.text.StringEscapeUtils.escapeHtml4(journal.getContent()) : "" %>">

                                    <!-- Hidden form for deletion -->
                                    <form id="deleteJournalForm"
                                        action="${pageContext.request.contextPath}/journal/delete" method="post"
                                        style="display:none;">
                                    ...
                                    <script>
                                        ...
                                        function renderDecorations() {
                                            // Get the raw JSON string from the hidden input (safely HTML-escaped by server)
                                            const contentInput = document.getElementById('journalContentData');
                                            if (!contentInput || !contentInput.value) return;

                                            // Decode HTML entities to get the original JSON string
                                            const textarea = document.createElement('textarea');
                                            textarea.innerHTML = contentInput.value;
