            ...
            <% } %>
              ...
              <div class="trash-list">
                <% List<RecycleBinItem> trashItems = (List<RecycleBinItem>) request.getAttribute("trashItems");
                    ...
                    <% } else { for (RecycleBinItem item : trashItems) { String itemType=item.getItemType(); boolean
                      isAutograph="autograph" .equals(itemType); String title=(item.getTitle() !=null &&
                      !item.getTitle().trim().isEmpty()) ? item.getTitle() : (isAutograph ? "Untitled Autograph"
                      : "Untitled Journal" ); String deletedDate=(item.getDeletedAt() !=null) ?
                      item.getDeletedAt().toString() : "Unknown" ; String icon=isAutograph ? "✍️" : "📝" ; String
                      restoreUrl=isAutograph ? request.getContextPath() + "/autograph/restore" :
                      request.getContextPath() + "/journal/restore" ; %>
                      <div class="trash-item">
                        <div class="trash-item-left">
                          <div
                            style="width:60px; height:60px; background:#e0e0e0; border-radius:8px; display:flex; align-items:center; justify-content:center; color:#777; font-weight:bold; font-size:24px;">
                            <%= icon %>
                          </div>
                          <div class="trash-details">
                            ...
                            <p class="trash-meta">
                              Type: <%= isAutograph ? "Autograph" : "Journal" %><br>
