    ...
    <body>
        ...
        <div class="subscription-page">
            <div class="subscription-container">
                ...
                <%-- For now, hardcoded to Basic plan. Backend will provide actual data. --%>
                    <% String currentPlan=(String) request.getAttribute("currentPlan"); if (currentPlan==null)
                        currentPlan="Basic" ; String planPrice=(String) request.getAttribute("planPrice"); if
                        (planPrice==null) planPrice="Free" ; String billingCycle=(String)
                        request.getAttribute("billingCycle"); if (billingCycle==null) billingCycle="—" ; String
                        renewalDate=(String) request.getAttribute("renewalDate"); if (renewalDate==null) renewalDate="—"
                        ; String storageUsed=(String) request.getAttribute("storageUsed"); if (storageUsed==null)
                        storageUsed="2.4" ; String storageTotal=(String) request.getAttribute("storageTotal"); if
                        (storageTotal==null) storageTotal="20" ; %>
                            ...
                            <div class="sub-card" style="grid-column: 1 / -1;">
                                ...
                                <div class="current-plan-header">
                                    <div class="current-plan-info">
                                        ...
                                        <p>
                                            <%= planPrice %>
                                                <%= !billingCycle.equals("—") ? "• Billed " + billingCycle : "" %>
                                        </p>
                                    </div>
                                ...
                                <div class="plan-detail-row">
                                    ...
                                    <span class="plan-detail-value">
                                        <%= currentPlan.equals("Basic") ? "None (Free plan)" : "•••• 4242" %>
                                    </span>
                                </div>
                            ...
                            <div class="sub-card">
                                ...
                                <div class="storage-bar-container">
                                    ...
                                    <div class="storage-bar-bg">
                                        <% double used=Double.parseDouble(storageUsed); double
                                            total=Double.parseDouble(storageTotal); int pct=(int) Math.round((used /
                                            total) * 100); String barClass=pct < 50 ? "low" : (pct < 80 ? "medium"
                                            : "high" ); %>
                                            <div class="storage-bar-fill <%= barClass %>" style="width: <%= pct %>%;">
                                            </div>
                                    </div>
                                ...
                                <div class="storage-breakdown">
                                    ...
                                    <div class="storage-item">
                                        <span class="storage-dot" style="background: #60a5fa;"></span>
                                        Videos — 0.8 GB
                                    </div>
                                    <div class="storage-item">
                                        <span class="storage-dot" style="background: #34d399;"></span>
                                        Journals — 0.3 GB
                                    </div>
                                    <div class="storage-item">
                                        <span class="storage-dot" style="background: #fbbf24;"></span>
                                        Other — 0.1 GB
                                    </div>
                                </div>
                                ...
                                <div class="sub-actions" style="margin-top: 20px;">
                                    ...
                                    <% if (pct> 70) { %>
                                        <a href="${pageContext.request.contextPath}/changeplan"
                                            class="sub-btn primary">Need More Space?</a>
                                        <% } %>
                                </div>
                            </div>

                            <!-- Quick Plan Comparison Card -->
                            <div class="sub-card">
                                <h3>
                                ...
                                <div style="display: flex; flex-direction: column; gap: 14px;">
                                    <div
                                        ...
                                        <div>
                                            <div style="font-size: 14px; font-weight: 600; color: #1a1a2e;">250 GB
                                                Storage</div>
                                    ...
                                    <div
                                        ...
                                        <span style="font-size: 20px;">🎨</span>
                                        <div>
                                            <div style="font-size: 14px; font-weight: 600; color: #1a1a2e;">All Themes
                                            </div>
                                            <div style="font-size: 12px; color: #9ca3af;">Personalize your experience
                                            </div>
                                        </div>
                                    </div>
                                    <div
                                        ...
                                        <span style="font-size: 20px;">🤖</span>
                                        <div>
                                            <div style="font-size: 14px; font-weight: 600; color: #1a1a2e;">Smart
                                                Journaling</div>
                                            <div style="font-size: 12px; color: #9ca3af;">AI-powered writing assistance
                                            </div>
                                        </div>
                                    </div>
                                    <div
                                        ...
                                        <span style="font-size: 20px;">🚫</span>
                                        <div>
                                            <div style="font-size: 14px; font-weight: 600; color: #1a1a2e;">Ad-Free
                                            </div>
                                            <div style="font-size: 12px; color: #9ca3af;">Enjoy without interruptions
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="sub-card" style="margin-bottom: 40px;">
                            ...
                            <% if (currentPlan.equals("Basic")) { %>
                                <div style="text-align: center; padding: 40px 20px; color: #9ca3af;">
                                    ...
                                    <p style="font-size: 15px; font-weight: 500; margin-bottom: 4px;">No billing history
                                        yet</p>
                                    <p style="font-size: 13px;">Upgrade to a paid plan to start seeing your invoices
                                        here.</p>
                                </div>
                                <% } else { %>
