                                        ...
                                        <div class="scrollable-feed" id="feedContainer">
                                            <% if (posts==null || posts.isEmpty()) { %>
                                                ...
                                                <% } else { for (FeedPost post : posts) { FeedProfile
                                                    poster=post.getFeedProfile(); String posterUsername=(poster !=null)
                                                    ? poster.getFeedUsername() : "unknown" ; String posterPic=(poster
                                                    !=null && poster.getFeedProfilePictureUrl() !=null) ?
                                                    poster.getFeedProfilePictureUrl() : null; String
                                                    posterInitials=(poster !=null) ? poster.getInitials() : "??" ;
                                                    String postCaption=(post.getCaption() !=null) ? post.getCaption() :
                                                    (post.getMemory() !=null ? post.getMemory().getTitle() : "" );
                                                    String coverMedia=post.getCoverMediaUrl(); %>
                                                    <!-- Dynamic Post -->
                                                    <div class="feed-post" data-post-id="<%= post.getPostId() %>">
                                                        <div class="post-header">
                                                            <div class="user-info">
                                                                <% if (posterPic !=null &&
                                                                    !posterPic.contains("default")) { %>
                                                                    <img src="<%= posterPic %>"
                                                                        alt="@<%= posterUsername %>" class="user-avatar"
