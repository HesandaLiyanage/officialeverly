    ...
    <body>
        ...
        <div class="page-wrapper">
            <div class="create-autograph-container">
                ...
                <form class="autograph-form" id="autographForm" action="/updateautograph" method="post"
                    enctype="multipart/form-data">

                    <p class="page-subtitle">Update the details below to edit your book and keep your memories up to
                        date.</p>
                    ...
                    <form class="autograph-form" id="autographForm"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" name="bookTitle" id="bookTitle"
                                placeholder="e.g., Graduation 2024, Summer Vacation" value="${autograph.title}" />
                        </div>
                ...
                ${autograph.description} </textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="link-input-wrapper">
                                ...
                                <input type="text" class="form-input link-input" name="customLink" id="customLink"
                                    placeholder="yourname" value="${autograph.title}" required />
                            ...
                            <p class="form-hint" id="fullLinkDisplay">Full link: everly.com/username/name your auto!!!
                            </p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <p class="form-hint">You can add your own message, photos, or voice notes to start the book.
                            </p>
                            ...
                            <p class="form-hint" id="fullLinkDisplay">Full link: everly.com/<span
                                    id="linkDisplayValue">${autograph.title}</span></p>
                            ...
                            <button type="submit" class="submit-btn">
                                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    ...
                                    <button type="button" class="cancel-btn"
                                        onclick="window.location.href='/autographs'">
                                        Cancel
                                    </button>
                                    <button type="submit" class="submit-btn">
