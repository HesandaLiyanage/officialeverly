    ...
    <body>
        ...
        <div class="page-wrapper">
            <div class="create-autograph-container">
                ...
                <p class="page-subtitle">Update the details below to edit your book and keep your memories up to date.
                </p>
                ...
                <form class="autograph-form" id="autographForm"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-input" name="bookTitle" id="bookTitle"
                            placeholder="e.g., Graduation 2024, Summer Vacation" value="${autograph.title}" required />
                    </div>
