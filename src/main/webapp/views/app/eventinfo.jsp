                ...
                <%@ page import="com.demo.web.dao.GroupDAO" %>
                    <%@ page import="java.text.SimpleDateFormat" %>
                        ...
                        <% // Check session Integer userId=(Integer) session.getAttribute("user_id"); if (userId==null)
                            ...
                            response.sendRedirect(request.getContextPath() + "/events" ); return; } catch (Exception e)
                            { e.printStackTrace();
                            session.setAttribute("errorMessage", "An error occurred while loading the event" );
                            response.sendRedirect(request.getContextPath() + "/events" ); return; } SimpleDateFormat
                            ...
                            <body>
                                ...
                                <div class="event-viewer-wrapper">
                                    <div class="event-viewer-container">
                                        ...
                                        <div class="event-banner-container">
                                            <img src="<%= eventPicUrl %>" alt="<%= event.getTitle() %>" id="eventBanner"
                                        ...
                                        <div class="event-description-section">
                                            ...
                                            <p class="event-description" id="eventDescription">
                                                <%= event.getDescription() !=null && !event.getDescription().isEmpty() ?
                                                    event.getDescription() : "No description available for this event."
                                                    %>
                                            </p>
                                        </div>
                                            ...
                                            <% if (isPastEvent) { %>
                                                ...
                                                <% } %>
                                                    <div class="secondary-actions">
                                                        ...
                                                        <button class="secondary-action-btn delete-btn"
                                                            id="deleteEventBtn">
                                                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
                                                                stroke="currentColor" stroke-width="2"
                                                                stroke-linecap="round" stroke-linejoin="round">
                                ...
                                <form id="deleteEventForm" method="POST"
                                    action="${pageContext.request.contextPath}/deleteEvent" style="display: none;">
