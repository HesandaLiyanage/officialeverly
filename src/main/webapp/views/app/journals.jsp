                      ...
                      <% } %>
                        ...
                        <div class="journals-grid" id="allJournalsGrid"
                          ...
                          <% if (journals==null || journals.isEmpty()) { %>
                            ...
                            <% } else { for (Journal journal : journals) { // Use the title as the date representation
                              (e.g., "24th October 2025" ) String displayDate=journal.getTitle(); // Assuming title is
                              the formatted date // Truncate content for preview (first 100 characters) String
                              contentPreview=journal.getContent(); if (contentPreview !=null && contentPreview.length()>
                              100) {
                  ...
                  journalCards.forEach(card => {
                    ...
                    card.addEventListener('click', function () {
                      ...
                      if (journalId) {
                        ...
                        window.location.href = contextPath + '/journalview?id=' + journalId;
                      }
                    });
                  });
                });
