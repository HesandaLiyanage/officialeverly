                      ...
                      <% } %>
                        ...
                        <div class="journals-grid" id="allJournalsGrid"
                          ...
                          <% if (journals==null || journals.isEmpty()) { %>
                            ...
                            <% } else { for (Journal journal : journals) { String displayDate=journal.getTitle(); String
                              rawContent=journal.getContent(); int wordCount=0; if (rawContent !=null &&
                              !rawContent.isEmpty()) { try { com.google.gson.JsonObject cObj=new
                              com.google.gson.Gson().fromJson(rawContent, com.google.gson.JsonObject.class); String
                              htmlText=cObj.get("htmlContent").getAsString(); String plainText=htmlText.replaceAll("<[^>]*>", "").trim();
                              ...
                              %>
                              <div class="journal-card" data-title="<%= journal.getTitle() %>"
                                data-journal-id="<%= journal.getJournalId() %>">
                                ...
                                <div class="journal-content">
                                  ...
                                  <% if (wordCount> 0) { %>
                                    <p style="font-size: 0.8rem; color: #9A74D8; margin-top: 8px; font-weight: 600;">
                                      <%= wordCount %> word<%= wordCount !=1 ? "s" : "" %> · Tap to read
                                    </p>
                                    <% } else { %>
                                      <p
                                        style="font-size: 0.8rem; color: #9ca3af; margin-top: 8px; font-style: italic;">
                                        Empty entry · Tap to view
                                      </p>
                                      <% } %>
                                </div>
                              </div>
