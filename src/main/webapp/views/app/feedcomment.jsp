                                                                ...
                                                                <div class="post-detail-header">
                                                                    <div class="user-info">
                                                                        ...
                                                                        <div class="user-details">
                                                                            <h4 class="username">
                                                                                ${postOwner.feedUsername}</h4>
                                                                            <c:if
                                                                                test="${not empty post.memory and not empty post.memory.memoryTitle}">
                                                                                <p class="post-location">
                                                                                    ${post.memory.memoryTitle}</p>
                                                                            </c:if>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="comments-list-container"
                                                                        ...
                                                                        <div class="comment-item original-caption">
                                                                            ...
                                                                            <div class="comment-content">
                                                                                <div class="comment-header">
                                                                                    <span
                                                                                        class="comment-username">${postOwner.feedUsername}</span>
                                                                                    <span
                                                                                        class="comment-time">${post.relativeTime}</span>
                                                                                </div>
                                                                                <p class="comment-text">${post.caption}
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                    </c:if>
                                                                    ...
                                                                    <c:if test="${empty comments}">
                                                                        <div class="no-comments">
                                                                            ...
                                                                            <h3 class="no-comments-title">No comments
                                                                                yet</h3>
                                                                            <p class="no-comments-subtitle">Start the
                                                                                conversation.</p>
                                                                        </div>
                                                                    </c:if>
                                                                    ...
                                                                    <c:forEach var="comment" items="${comments}"
                                                                        varStatus="loop">
                                                                        <c:set var="commenter"
                                                                            value="${comment.feedProfile}" />
                                                                        <c:set var="commenterPic"
                                                                            value="${commenter.feedProfilePictureUrl}" />
                                                                        <c:set var="hasCommenterPic"
                                                                            value="${not empty commenterPic and not fn:contains(commenterPic, 'default')}" />
                                                                        <c:set var="commentLiked"
                                                                            value="${comment.likedByCurrentUser}" />
                                                                        <c:set var="likedClass"
                                                                            value="${commentLiked ? 'liked' : ''}" />
                                                                        <c:set var="fillColor"
                                                                            value="${commentLiked ? '#ed4956' : 'none'}" />
                                                                        <c:set var="strokeColor"
                                                                            value="${commentLiked ? '#ed4956' : 'currentColor'}" />
                                                                        <c:set var="cLikeCount"
                                                                        ...
                                                                        <div class="comment-item"
                                                                            ...
                                                                            <div class="comment-content">
                                                                                <div class="comment-header">
                                                                                    <span
                                                                                        class="comment-username">${commenter.feedUsername}</span>
                                                                                    <span
                                                                                        class="comment-time">${comment.relativeTime}</span>
                                                                                </div>
                                                                                ...
                                                                                <div class="comment-actions">
                                                                                    ...
                                                                                    <c:if test="${cLikeCount > 0}">
                                                                                        <span
                                                                                            class="comment-likes">${cLikeCount}
                                                                                            likes</span>
                                                                                    </c:if>
                                                                                    <button class="reply-btn"
                                                                                        data-username="${commenter.feedUsername}">Reply</button>
                                                                                    <c:if test="${canDelete}">
                                                                                        <button
                                                                ...
                                                                <div class="post-actions-bar">
                                                                    ...
                                                                    <div class="post-stats">
                                                                        ...
                                                                        <p class="post-time-stamp">
                                                                            ${fn:toUpperCase(post.relativeTime)}</p>
                                                                    </div>
                                                                </div>
