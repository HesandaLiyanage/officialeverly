...
<head>
    ...
    <title>@${fn:escapeXml(profileUsername)} - Everly</title>
    ...
    <div class="feed-shell">
        <aside class="feed-rail">
            ...
            <div class="feed-rail-bottom">
                <a href="${pageContext.request.contextPath}/publicprofile" class="feed-rail-link${isOwnProfile ? ' active' : ''}">
                    <span class="feed-rail-link-icon">
                        <c:choose>
                ...
                <div class="scrollable-feed" id="feedContainer">
                    ...
                    <div class="profile-info">
                                ...
                                <c:otherwise>
                                    <div class="profile-action-buttons">
                                        <button class="follow-btn${isFollowing ? ' following' : ''}"
                                            id="followBtn" data-profile-id="${profileId}" data-is-following="${isFollowing}">
                                            <c:choose>
                                        ...
                                        <button class="block-btn${isBlocked ? ' blocked' : ''}" id="blockBtn"
                                            data-profile-id="${profileId}" data-username="${fn:escapeXml(profileUsername)}"
                                            ...
                                            <c:choose>
                                                <c:when test="${isBlocked}">Blocked</c:when>
                        ...
                        <div class="profile-stats">
                            <span><strong id="postCount">${postCount}</strong> posts</span>
                        ...
                        <div id="postsSection" class="posts-container">
                            <c:choose>
                                ...
                                <p>
                                    <c:choose>
                                        <c:when test="${isOwnProfile}">Share your first memory to the feed!</c:when>
                                        <c:otherwise>This user hasn't shared any posts yet.</c:otherwise>
                                    </c:choose>
                                </p>
                                <c:if test="${isOwnProfile}">
                                    ...
                                    <div class="profile-post-item"
                                        ...
                                        <c:choose>
                                            <c:when test="${not empty post.coverMediaUrl}">
                                                <img src="${fn:escapeXml(post.coverMediaUrl)}" alt="Post">
                                            </c:when>
                                            <c:otherwise>
                                                <div
            ...
            <aside class="sidebar">
                ...
                <div class="sidebar-section">
                    <div class="sidebar-title-row">
                        ...
                        <a href="${pageContext.request.contextPath}/following?profileId=${profileId}" class="sidebar-link">Following</a>
                    </div>
                                ...
                                <c:forEach items="${recommendedUsers}" var="user" varStatus="status">
                                    ...
                                    <li class="favorite-item">
                                        ...
                                        <button class="follow-btn-small"
                                                ...
                                                onclick="handleFollow(this, ${user.feedProfileId})">Follow</button>
                                    </li>
                                </c:forEach>
                            </c:when>
                            <c:otherwise>
                                <li class="sidebar-note">No suggestions available right now.</li>
                            </c:otherwise>
                        </c:choose>
                    </ul>
                </div>
