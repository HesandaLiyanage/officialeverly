...
<body>
    ...
    <main class="profile-container">
        ...
        <c:if test="${not empty successMessage}">
            <div class="success">${fn:escapeXml(successMessage)}</div>
        </c:if>
        ...
        <form action="${pageContext.request.contextPath}/updateFeedProfile"
                    ...
                    <div class="picture-preview-wrapper">
                        <c:choose>
                            <c:when test="${!hasDefaultPic}">
                                <img src="${fn:escapeXml(feedProfilePicture)}" alt="Profile"
            ...
            <div class="form-group">
                ...
                <input type="text" id="username" name="username"
                    value="@${fn:escapeXml(feedUsername)}" disabled
            ...
            <div class="form-group">
                ...
                <textarea id="bio" name="bio"
                    ...
                    maxlength="500">${fn:escapeXml(feedBio)}</textarea>
                <div class="char-count">
                    <span id="bioCount">${feedBioLength}</span>/500
                </div>
            </div>
