        ...
        <main class="main-content follow-page-main">
            <div class="follow-card">
                <div class="followers-header">
                    ...
                    <a href="${pageContext.request.contextPath}/following?profileId=${profileToView.feedProfileId}" class="sidebar-link">Following</a>
                </div>

                <div class="follow-search">
                    <input type="text" id="followSearchInput" placeholder="Search followers by username">
                </div>
