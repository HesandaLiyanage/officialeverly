...
<body>
  ...
  <div class="page-wrapper">
    <main class="main-content">
      ...
      <div class="members-grid">
        <c:choose>
          <c:when test="${not empty memberDisplayData}">
            <c:forEach var="m" items="${memberDisplayData}">
              <div class="member-card">
                <a href="${pageContext.request.contextPath}/groupprofile?memberId=${m.memberId}&groupId=${groupId}"
                  style="display: flex; align-items: center; text-decoration: none; color: inherit; flex: 1;">
                  <div class="member-avatar" style="background: ${m.avatarColor}; color: white;">
                    ${m.initials}
                  </div>
                ...
                <c:if test="${isAdmin and not m.isAdminMember}">
  ...
  <div class="invite-modal-overlay" id="inviteModal">
    <div class="invite-modal">
      <h3>Invite Members to ${fn:escapeXml(groupName)}</h3>
