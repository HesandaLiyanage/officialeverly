...
<c:if test="${empty group}">
  <c:redirect url="${pageContext.request.contextPath}/groups" />
</c:if>
    ...
    <div class="page-wrapper">
        <div class="create-group-container">
            ...
            <form class="group-form" id="groupForm"
                action="${pageContext.request.contextPath}/editgroupservlet" method="post"
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-input" name="g_name" id="g_name"
                        ...
                        value="${fn:escapeXml(group.name)}" required />
                </div>
                ...
                <div class="form-actions">
                    <button type="button" class="cancel-btn"
                        onclick="window.location.href='${pageContext.request.contextPath}/groupmemories?groupId=${group.groupId}'">
                        Cancel
                    </button>
    ...
    <div id="deleteModal"
        ...
        <div
            ...
            <div style="display: flex; gap: 12px;">
                ...
                <form action="${pageContext.request.contextPath}/deletegroupservlet" method="POST"
                    style="flex: 1;">
                    <input type="hidden" name="groupId" value="${group.groupId}">
                    <button type="submit"
