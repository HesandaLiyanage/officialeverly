            ...
            <div class="search-filters" style="margin-top: 10px; margin-bottom: 15px;">
                ...
                <div class="group-memories-count">
                    <c:if test="${not empty memories}">
                        ${fn:length(memories)} ${fn:length(memories) == 1 ? 'memory' : 'memories'}
                    </c:if>
                </div>
            </div>
                ...
                <c:choose>
                    ...
                    <c:otherwise>
                        <c:forEach var="memory" items="${memories}">
                            ...
                            <div class="memory-card" data-title="${fn:escapeXml(memory.title)}"
                                ...
                                <div class="memory-content">
                                    <h3 class="memory-title">${fn:escapeXml(memory.title)}</h3>
                                    <p class="memory-date">
                                    ...
                                    <c:if test="${not empty memory.description}">
                                        <p class="memory-description"
                                            ...
                                            ${fn:escapeXml(memory.description)}
                                        </p>
                                    </c:if>
                                </div>
                            </div>
            ...
            <div class="floating-buttons" id="floatingButtons"
                ...
                <c:if test="${not isAdmin}">
                    <button onclick="leaveGroup(${groupId})"
                        class="floating-btn" style="background: #ef4444;">
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none"
