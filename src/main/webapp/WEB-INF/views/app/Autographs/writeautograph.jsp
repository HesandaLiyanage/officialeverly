...
<body>
    ...
    <div class="write-autograph-wrapper">
        <div class="write-autograph-container">
            ...
            <div class="write-header">
                ...
                <p class="book-subtitle">For ${fn:escapeXml(displayTitle)}</p>
            </div>
    ...
    <script>
        class AutographWriter {
            ...
            submitAutograph() {
                ...
                formData.append('token', '${fn:escapeXml(shareToken)}');
    ...
    <form id="autographForm" action="${pageContext.request.contextPath}/submit-autograph" method="post"
        ...
        <input type="hidden" name="token" value="${fn:escapeXml(shareToken)}">
