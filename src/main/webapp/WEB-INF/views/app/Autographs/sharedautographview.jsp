...
<body>
    ...
    <div class="shared-view-header">
        <h1><c:out value="${autographTitle}" /></h1>
        <p>Viewing all entries in this autograph book</p>
        <a href="${pageContext.request.contextPath}/share/${fn:escapeXml(shareToken)}"
                ...
                <c:forEach var="entry" items="${entries}">
                    <div class="entry-card">
                        ...
                        <div class="entry-date">
                            <c:choose>
                                <c:when test="${not empty entry.submittedAt}">
                                    ${fn:substring(entry.submittedAt, 0, 16)}
                                </c:when>
