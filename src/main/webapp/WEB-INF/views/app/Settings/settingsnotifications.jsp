<%@ page contentType="text/html;charset=UTF-8" language="java" %>
    <%@ page import="java.util.Map" %>
        <% Map<String, Boolean> prefs = (Map<String, Boolean>) request.getAttribute("notifPrefs");
                if (prefs == null) {
                            ...
                            <div class="notif-list">
                                <div class="notif-row">
                                    ...
                                    <label class="toggle-switch">
                                        <input type="checkbox" data-type="memory_uploads" <%=prefs.get("memory_uploads")
                                            ? "checked" : "" %>>
                                ...
                                <div class="notif-row">
                                    ...
                                    <label class="toggle-switch">
                                        <input type="checkbox" data-type="comments_reactions"
                                            <%=prefs.get("comments_reactions") ? "checked" : "" %>>
                                        <span class="toggle-slider"></span>
                                    </label>
                                </div>
                                ...
                                <div class="notif-row">
                                    ...
                                    <label class="toggle-switch">
                                        <input type="checkbox" data-type="group_announcements"
                                            <%=prefs.get("group_announcements") ? "checked" : "" %>>
                                        <span class="toggle-slider"></span>
                                    </label>
                                </div>
                                ...
                                <div class="notif-row">
                                    ...
                                    <label class="toggle-switch">
                                        <input type="checkbox" data-type="event_updates" <%=prefs.get("event_updates")
                                            ? "checked" : "" %>>
                                        <span class="toggle-slider"></span>
                                    </label>
                                </div>
                                ...
                                <div class="notif-row">
                                    ...
                                    <label class="toggle-switch">
                                        <input type="checkbox" data-type="group_invites" <%=prefs.get("group_invites")
                                            ? "checked" : "" %>>
                                        <span class="toggle-slider"></span>
                                    </label>
                                </div>
                                ...
                                <div class="notif-row">
                                    ...
                                    <label class="toggle-switch">
                                        <input type="checkbox" data-type="memory_recaps" <%=prefs.get("memory_recaps")
                                            ? "checked" : "" %>>
                                        <span class="toggle-slider"></span>
                                    </label>
                                </div>
