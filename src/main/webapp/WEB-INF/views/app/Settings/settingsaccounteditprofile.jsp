<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
  <%@ page import="com.demo.web.model.Auth.user" %>
    <!DOCTYPE html>
    <html>
      ...
      <div class="settings-container">
        ...
        <div class="edit-profile-section">
          ...
          <% user currentUser=(user) session.getAttribute("user"); if (currentUser==null) {
            response.sendRedirect(request.getContextPath() + "/login" ); return; } String errorMsg=(String)
            request.getAttribute("error"); String successMsg=(String) request.getAttribute("success"); %>
                    ...
                    <form action="${pageContext.request.contextPath}/editprofileservlet" method="post"
                      ...
                      <div class="form-group">
                        ...
                        <textarea name="bio" class="form-textarea"
                          placeholder="Tell us about yourself"><%= currentUser.getBio() != null ? currentUser.getBio() : "" %></textarea>
                      </div>
